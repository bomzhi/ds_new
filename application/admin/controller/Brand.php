    ...
    public function brand_add() {
        ...
        if (request()->isPost()) {
            ...
            if (!$brand_validate->scene('brand_add')->check($data)) {
                ...
                $insert_array['class_id'] = input('post.class_id');
                ...
                $insert_array['show_type'] = intval(input('post.show_type')) == 1 ? 1 : 0;
    ...
    public function brand_edit() {
        ...
        if (request()->isPost()) {
            ...
            if (!$brand_validate->scene('brand_edit')->check($data)) {
                ...
                $brand_info = $brand_model->getBrandInfo(array('brand_id' => intval($_POST['brand_id'])));
                $where = array();
                ...
                $update_array['class_id'] = input('post.class_id');
                ...
                $update_array['show_type'] = intval(input('post.show_type')) == 1 ? 1 : 0;
            ...
            if (!empty($_POST['del_id'])) {
                switch ($_POST['type']) {
                    ...
                    case 'refuse':
                        ...
                        $this->log(lang('ds_del') . lang('brand_index_brand') . '[ID:' . implode(',', $_POST['del_id']) . ']', 1);
