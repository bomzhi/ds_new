...
public function _initialize()
{
        ...
        if ($search_field_value != '') {
            switch ($search_field_name) {
                ...
                case 'orderinviter_store_name':
                    $condition['orderinviter_store_name'] = $search_field_value;
                    break;
            }
        }
    ...
    public function member(){
        ...
        $member_list = $inviter_model->getInviterList($condition, 10,'','i.*,m.inviter_id as inviter_parent_id,m.member_id,m.member_ww,m.member_qq,m.member_time,m.member_name,m.member_avatar,m.member_email,m.member_mobile,m.member_truename');
    ...
    public function memberinfo(){
        ...
        $inviter_model=model('inviter');
        $inviter_info=$inviter_model->getInviterInfo(array('i.inviter_id'=>$member_id),'i.*,m.inviter_id as inviter_parent_id,m.member_id,m.member_ww,m.member_qq,m.member_time,m.member_name,m.member_avatar,m.member_email,m.member_mobile,m.member_truename');
        if(!$inviter_info){
            ds_json_encode('10001', lang('inviter_member_empty'));
        }
    ...
    public function memberlist(){
        ...
        $inviter_model=model('inviter');
        if($type==1){
            $res=db('member')->alias('m')->join('__INVITER__ i', 'i.inviter_id=m.member_id','LEFT')->field('i.*,m.inviter_id as inviter_parent_id,m.member_id,m.member_ww,m.member_qq,m.member_time,m.member_name,m.member_avatar,m.member_email,m.member_mobile,m.member_truename')->where('m.inviter_id='.$member_id)->order('inviter_applytime desc')->paginate(10,false,['query' => request()->param()]);
            $page_info=$res;
            ...
            $res=db('member')->alias('m')->join('__INVITER__ i', 'i.inviter_id=m.member_id','LEFT')->field('i.*,m.inviter_id as inviter_parent_id,m.member_id,m.member_ww,m.member_qq,m.member_time,m.member_name,m.member_avatar,m.member_email,m.member_mobile,m.member_truename')->where('m.inviter_id IN'.$subQuery)->order('inviter_applytime desc')->paginate(10,false,['query' => request()->param()]);
            $page_info=$res;
            $member_list=$res->items();
        }elseif($type==3){
            $subQuery=db('member')->alias('m')->join('__INVITER__ i', 'i.inviter_id=m.member_id','LEFT')->field('m.member_id')->where('m.inviter_id='.$member_id)->order('inviter_applytime desc')->buildSql();
