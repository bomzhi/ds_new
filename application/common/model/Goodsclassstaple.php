...
class Goodsclassstaple extends Model {
    ...
    public function getGoodsclassstapleList($condition, $field = '*', $order = 'staple_counter desc', $limit = 20) {
        $result = db('goods_class_staple')->field($field)->where($condition)->order($order)->limit($limit)->select();
        return $result;
    }
    ...
    public function getGoodsclassstapleInfo($condition, $field = '*') {
        $result = db('goods_class_staple')->field($field)->where($condition)->find();
        return $result;
    }
    ...
    public function addGoodsclassstaple($data) {
        $result = db('goods_class_staple')->insertGetId($data);
        return $result;
    }
    ...
    public function editGoodsclassstaple($update, $where) {
        $result = db('goods_class_staple')->where($where)->update($update);
        return $result;
    }
    ...
    public function delGoodsclassstaple($condtion) {
        $result = db('goods_class_staple')->where($condtion)->delete();
        return $result;
    }
