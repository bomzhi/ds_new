...
class Storebindclass extends Model {
    ...
    public function getStorebindclassList($condition, $page = '', $order = '', $field = '*') {
        if($page){
            $result = db('store_bind_class')->field($field)->where($condition)->order($order)->paginate($page,false,['query' => request()->param()]);
            $this->page_info = $result;
            return $result->items();
        }else{
            $result = db('store_bind_class')->field($field)->where($condition)->order($order)->select();
            return $result;
        }
    }
    ...
    public function getStorebindclassInfo($condition) {
        $result = db('store_bind_class')->where($condition)->find();
        return $result;
    }
    ...
    public function addStorebindclass($data) {
        return db('store_bind_class')->insertGetId($data);
    }
    ...
    public function addStorebindclassAll($data) {
        return db('store_bind_class')->insertAll($data);
    }
    ...
    public function editStorebindclass($update, $condition) {
        return db('store_bind_class')->where($condition)->update($update);
    }
    ...
    public function delStorebindclass($condition) {
        return db('store_bind_class')->where($condition)->delete();
    }
    ...
    public function getStorebindclassCount($condition = array()) {
        return db('store_bind_class')->where($condition)->count();
    }
