        ...
        if ($orderinviter_list) {
            ...
            foreach ($orderinviter_list as $val) {
                ...
                if ($inviter) {
                    ...
                    $goodscommon = db('goods_common')->where('goods_commonid=' . $val['orderinviter_goods_commonid'])->lock(true)->find();
                    ...
                    if ($goodscommon) {
                        ...
                        if (!empty($goodscommon_data)) {
                            $mysql_flag = db('goods_common')->where('goods_commonid=' . $val['orderinviter_goods_commonid'])->update($goodscommon_data);
                            if (!$mysql_flag) {
