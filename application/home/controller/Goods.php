...
class Goods extends BaseGoods {
    ...
    public function index() {
       ...
       // halt($goods_info);
        ...
        //推荐商品 
        $goods_commend_list = $goods_model->getGoodsOnlineList(array('store_id' => $goods_info['store_id'], 'goods_commend' => 1), 'goods_id,goods_name,goods_jingle,goods_image,store_id,goods_price', 0, '', 5, 'goods_commonid');
        ...
        $seo_param['description'] = ds_substing($goods_info['goods_body']);
