<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\dsmall\public/../application/admin\view\public\dispatch_jump.html";i:1545196757;}*/ ?>
...
<body>
    <div class="system-message">
        <?php switch ($code) {case 1:?>
            <h1><img src="<?php echo ADMIN_SITE_ROOT; ?>/images/dispatch_jump_success.png"/>操作成功!</h1>
            <p class="success"><?php echo(strip_tags($msg));?></p>
            <?php break;case 0:?>
            <h1><img src="<?php echo ADMIN_SITE_ROOT; ?>/images/dispatch_jump_error.png"/>有错误发生!</h1>
